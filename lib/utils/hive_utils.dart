...
class HiveUtils {
  ...
  static dynamic getExpandedCategoryId() {
    return Hive.box(HiveKeys.userDetailsBox).get(HiveKeys.expandedCategoryID) ??
        "";
  }

  static dynamic setExpandedCategoryId(String id) {
    Hive.box(HiveKeys.userDetailsBox).put(HiveKeys.expandedCategoryID, id);
  }
