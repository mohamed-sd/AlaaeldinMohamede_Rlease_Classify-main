...
import 'package:Bareeq/ui/screens/widgets/full_screen_image_view.dart';
import 'package:Bareeq/ui/screens/widgets/gallery_view.dart';
...
import 'package:Bareeq/utils/network_to_localsvg.dart';
    ...
    return SystemUiOverlayStyle(
        ...
        statusBarBrightness: brightness ??
            (context.watch<AppThemeCubit>().state.appTheme == AppTheme.dark
                ? Brightness.dark
                : Brightness.light),
        statusBarIconBrightness: brightnessIcon ??
            (context.watch<AppThemeCubit>().state.appTheme == AppTheme.dark
                ? Brightness.light
                : Brightness.dark));
  }
